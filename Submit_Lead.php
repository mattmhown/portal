...
<head>
  ...
  <title>Submit Lead - HOWN Portal</title>
</head>
...
<body>
  ...
  <div class="form-container">
    <h2 style="padding-bottom: 10px;">Submit Client Details</h2>
    <form id="referral-form">
      ...
      <!-- State Dropdown -->
      <div class="state-dropdown-group">
        <label for="state">State:</label>
        <select id="state" name="state" class="state-dropdown">
  ...
  <div class="container mt-5 text-center">
    <div class="text-box" style="
        ...
        ">
      <h1>Quick Guide: How to Refer Clients</h1>
      <h5>Our short video below outlines the simple step to refer a client.</h5>
      <h3 style="margin-top: 20px; font-weight: bold">Video instructions</h3>
    </div>
    <div class="video-container" style="
          ...
          margin-top: 20px;
        ">
      <video id="video" style="width: 100%; max-width: 1000px; height: auto" controls>
        <source
      ...
      <div class="play-button" style="
            ...
            cursor: pointer;
          ">
        <img src="https://www.freeiconspng.com/uploads/play-button-icon-png-2.png" alt="Play Button"
