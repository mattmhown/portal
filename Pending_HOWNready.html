...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Instead of an image, use an input container for the interactive text box */
    ...
    /* Wrap the card text and button in a flex container so the button appears to the right */
    .card-text-container {
      display: flex;
  ...
  <script>
    ...
    // Function to check the interactive input and display an alert message
    function submitData(event) {
      event.preventDefault();
      var inputVal = document.getElementById("interactiveInput").value.trim();
      const defaultText = "Enter/paste client data here: \n(one per line, max 15 clients)\ne.g\njohn doe, 0400000000\njane smith, 0411111111 ...";

      // Check if the input value is not empty and not the default placeholder text
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      const textarea = document.getElementById('interactiveInput');
      const maxRows = 15;
      ...
      textarea.addEventListener('input', function (event) {
        ...
        if (lines.length > maxRows) {
          ...
          this.scrollTop = this.scrollHeight; // Keep cursor at the bottom
          alert("You have reached the maximum number of rows (15).");
        }
      });
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
      ...
      textarea.style.color = "#756d6d"; // Placeholder color

      textarea.addEventListener('focus', function () {
        if (this.value === defaultText) {
          this.value = ''; // Clear on focus
          this.style.color = "black"; // Change text color to black on focus
        }
      });

      textarea.addEventListener('blur', function () {
        if (this.value.trim() === '') {
          this.value = defaultText; // Restore default text if empty
          this.style.color = "#756d6d"; // Restore placeholder color if empty
        }
      });
      ...
      textarea.addEventListener('input', function () {
        if (this.value.trim() !== '' && this.value !== defaultText) {
          this.style.color = "black"; // Change text color to black when the user starts typing
        }
      });
    });
  </script>

  <title>HOWNready - HOWN Portal</title>
</head>
    ...
    <div class="content">
      ...
      <div class="container text-center" style="margin-top: 20px; margin-bottom: 10px;">
        <div class="row g-4 justify-content-center">
          <!-- Original HOWNready SMS Card -->
          <div class="col-md-6 d-flex justify-content-center">
            <div class="card interactive-card" style="background-color: transparent;">
              <!-- Card Input Container with Send Button -->
              <div class="card-input-container" style="position: relative;">
                <textarea id="interactiveInput" class="form-control interactive-input"></textarea>
                <!-- Send Button Positioned at Bottom Right -->
                <a href="#" class="btn btn-primary" onclick="submitData(event)"
                  style="position: absolute; bottom: 10px; right: 10px;">Send</a>
              </div>

              <!-- Card Body with Image on the Left -->
              <div class="card-body d-flex align-items-center">
                <!-- Small Image on the Left -->
                <img src="C:\Users\matt\OneDrive\Desktop\PartnerPortal_V2\Frontend_Bare\Frontend_bootstrap\hownready.png" alt="Image"
                  style="width: 60%; height: 60%; margin-right: 0px;">

                <!-- Title and Text Adjusted to the Right -->
                <div class="text-container">
                  <h5 class="card-title">SMS Invitation</h5>
                  <p class="card-text" style="margin:0;">Prepare your prospective buyers. Invite them to use HOWNready
                    via an sms link.</p>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="row g-4">
              ...
              <div class="col-6 d-flex justify-content-center">
                <div class="card interactive-card" style="background-color: transparent;">
                  <img src="C:\Users\matt\OneDrive\Desktop\PartnerPortal_V2\Frontend_Bare\Frontend_bootstrap\vecteezy_silhouette-of-hand-holding-phone-background-transparent_45551747.png" class="card-img-top" alt="New Feature 1">
                  <div class="card-body">
                    <h5 class="card-title" style="padding-top: 2px; font-size: 18px; font-weight: normal;">QR code & MMS</h5>
                  </div>
                </div>
              </div>
              <!-- Card 2 -->
              <div class="col-6 d-flex justify-content-center">
                <div class="card interactive-card" style="background-color: transparent;">
                  <img src="C:\Users\matt\OneDrive\Desktop\PartnerPortal_V2\Frontend_Bare\Frontend_bootstrap\311092c3467c45c938fd5b63ac29281a.png" class="card-img-top" alt="New Feature 2">
                  <div class="card-body">
                    <h5 class="card-title" style="padding-top: 2px; font-size: 18px; font-weight: normal;">FAQ</h5>
                  </div>
                </div>
              </div>
              <!-- Card 3 -->
              <div class="col-6 d-flex justify-content-center">
                <div class="card interactive-card" style="background-color: transparent;">
                  <img src="C:\Users\matt\OneDrive\Desktop\PartnerPortal_V2\Frontend_Bare\Frontend_bootstrap\sms-text-messaging-computer-icons-mobile-phones-telephone-call-sms-pictures-icon-2c023d8a736c225e4d748baba5e8c130.png" class="card-img-top" alt="New Feature 3">
                  <div class="card-body">
                    <h5 class="card-title" style="padding-top: 2px; font-size: 18px; font-weight: normal;">SMS Example</h5>
                  </div>
                </div>
              </div>
              <!-- Card 4 -->
              <div class="col-6 d-flex justify-content-center">
                <div class="card interactive-card" style="background-color: transparent;">
                  <img src="C:\Users\matt\OneDrive\Desktop\PartnerPortal_V2\Frontend_Bare\Frontend_bootstrap\web-development-computer-icons-favicon-website-search-engine-optimization-www-web-site-internet-icon-97e6941d0b05c2dbb79c9361acc0e3ee.png" class="card-img-top" alt="New Feature 4">
                  <div class="card-body">
                    <h5 class="card-title" style="padding-top: 2px; font-size: 18px; font-weight: normal;">HOWNready URL</h5>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="sticky-controls">
            ...
            <div class="extra-buttons">
              <button type="button"
                ...
                onclick="alert('Help: AI assistant');" class="btn btn-secondary">Help</button>
              <button type="button"
                style="color: #ffffff; background-color: #0dcaf0; letter-spacing: 2px; font-size: 18px; --bs-btn-border-width: 0;"
